...
# download datastes
wget https://github.com/TannerGilbert/Detectron2-Train-a-Instance-Segmentation-Model/raw/master/microcontroller_segmentation_data.zip -O ../../datasets/microcontroller_segmentation_data.zip
wget https://github.com/matterport/Mask_RCNN/releases/download/v2.1/balloon_dataset.zip -O ../../datasets/balloon_dataset.zip
