...
#%%
def loadCocoDataset(dataset_path,dataset_name,image_root,anno_file_name='_annotations.coco.json') :
    ...
    for d in ["train","test","valid"]:
        register_coco_instances(
            ...
            os.path.join(dataset_path,dataset_name,f'_label/{d}.json'),
            # f"{}/{d}.json",
            # os.path.join(dataset_path,dataset_name,d)
            image_root=os.path.join(dataset_path,dataset_name,image_root)
        )
